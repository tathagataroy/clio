...
(function (factory) {
  ...
  if (typeof define === 'function') {
    define('common/graph/config',['angular','common/config'], function(angular){
     factory(angular); 
    });
  } else {
    factory(angular);
...
(function(factory) {
  ...
  if (typeof define === 'function') {
    define('graph',['angular', 'highcharts3D', 'common/graph/config'], function(angular){
     factory(angular); 
    });
  } else {
    factory(angular);
...
!function(t){define("templates",["angular"],function(a){t(a)})}(function(t){t.module("templates",[]),t.module("templates").run(["$templateCache",function(t){t.put("scripts/common/graph/graph.html",'<div chart-data="graphData"></div>')}])});
/*
# Copyright (c) 2001-2015, Aruba Networks, Inc.
# This material contains trade secrets and confidential information of Aruba
# Networks, Inc.
...
(function() {
  ...
  requirejs.config({
   ...
   paths: {
      ...
      'highchartsMore': '../scripts/lib/highcharts-more',
      'highcharts3D': '../scripts/lib/highcharts-3d',
      'templates': '../dist/assets/graph-amd/templates',
      'graph': '../scripts/common/graph/graph.directive',
    },
    shim : {
      'angular': {
        exports: 'angular',
  ...
  require(['templates','graph'],
     ...
     */
    function initialize() {
      var clio = angular.module("clio", ['awUIFramework.common.graph']);
      clio.controller('testController', ['$scope', function($scope){
        var options = {
          chart: {
            type:'column',
            options3d: {
        ...
        var data = {
         ...
         // shallow copy because api only returns series
       $scope.chartData = angular.extend(options, data);
      }]);
...
define("../amd/graphAmdConfig", function(){});
